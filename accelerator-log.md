...
{
  "interfaceType" : "http",
  "projectName" : "andrew-where-for-dinner-0"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"artifactVersion":"0.0.1-beta","dynamicMsgBroker":false,"dbType":"h2","enableCloudEvents":false,"interfaceType":"http","enableSecurity":false,"includeBuildToolWrapper":true,"msgbrokerName":"msgbroker-where-for-dinner","numRabbitMQClusterNodes":1,"secureProfile":"secure","artifactId":"andrew-where-for-dinner-0","serviceNamespace":"service-instances","projectName":"andrew-where-for-dinner-0","workloadNamespace":"workloads","msgBrokerType":"rabbitmq","cacheType":"inmemCache"}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input12136978659899059728, --data-values-file, /tmp/accelerator-options18195557656317361280.json, --output-files, /tmp/ytt-output6649465131584826290]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"artifactVersion":"0.0.1-beta","dynamicMsgBroker":false,"dbType":"h2","enableCloudEvents":false,"interfaceType":"http","enableSecurity":false,"includeBuildToolWrapper":true,"msgbrokerName":"msgbroker-where-for-dinner","numRabbitMQClusterNodes":1,"secureProfile":"secure","artifactId":"andrew-where-for-dinner-0","serviceNamespace":"service-instances","projectName":"andrew-where-for-dinner-0","workloadNamespace":"workloads","msgBrokerType":"rabbitmq","cacheType":"inmemCache"}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input4781034054926763148, --data-values-file, /tmp/accelerator-options4161827967144682988.json, --output-files, /tmp/ytt-output4622848999613312966]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"artifactVersion":"0.0.1-beta","dynamicMsgBroker":false,"dbType":"h2","enableCloudEvents":false,"interfaceType":"http","enableSecurity":false,"includeBuildToolWrapper":true,"msgbrokerName":"msgbroker-where-for-dinner","numRabbitMQClusterNodes":1,"secureProfile":"secure","artifactId":"andrew-where-for-dinner-0","serviceNamespace":"service-instances","projectName":"andrew-where-for-dinner-0","workloadNamespace":"workloads","msgBrokerType":"rabbitmq","cacheType":"inmemCache"}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input7084860452194616409, --data-values-file, /tmp/accelerator-options11952308676778514257.json, --output-files, /tmp/ytt-output18141036862606602754]
